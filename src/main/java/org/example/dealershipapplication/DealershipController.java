...
public class DealershipController {
    ...
    private void handleTransferVehicle(ActionEvent event) {
        // We need FROM dealer, TO dealer, and Vehicle ID
    ...
    private void handlePrintInventory(ActionEvent event) {
        // Prompt for which dealer to print
    ...
    private void handleSetDealerName(ActionEvent event) {
        // Ask for Dealer ID, then new name
    ...
    private void showVehicleDialog(String title, VehicleHandler handler) {
        // Similar to your original method, but we skip the "Dealer ID" prompt
        // because that's handled beforehand. This method just collects vehicle data.
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == addButtonType) {
                try {
                    ...
                    // We'll set the acquisitionDate to "today"
